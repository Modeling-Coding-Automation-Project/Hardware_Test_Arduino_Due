...
constexpr std::size_t INPUT_SIZE = servo_motor_constraints_lti_mpc_lkf::INPUT_SIZE;
constexpr std::size_t STATE_SIZE = servo_motor_constraints_lti_mpc_lkf::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE = servo_motor_constraints_lti_mpc_lkf::OUTPUT_SIZE;

constexpr std::size_t AUGMENTED_STATE_SIZE = STATE_SIZE + OUTPUT_SIZE;

constexpr std::size_t NUMBER_OF_DELAY = servo_motor_constraints_lti_mpc_lkf::NUMBER_OF_DELAY;
