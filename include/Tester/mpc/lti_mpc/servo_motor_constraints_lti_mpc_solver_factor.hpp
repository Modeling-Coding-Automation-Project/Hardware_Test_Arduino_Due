#ifndef SERVO_MOTOR_CONSTRAINTS_LTI_MPC_SOLVER_FACTOR_HPP_
#define SERVO_MOTOR_CONSTRAINTS_LTI_MPC_SOLVER_FACTOR_HPP_
...
#endif // SERVO_MOTOR_CONSTRAINTS_LTI_MPC_SOLVER_FACTOR_HPP_
