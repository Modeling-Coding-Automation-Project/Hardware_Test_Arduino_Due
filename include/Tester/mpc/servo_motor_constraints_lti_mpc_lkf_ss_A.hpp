...
using SparseAvailable_lti_mpc_lkf_ss_A = SparseAvailable<
...
using type = SparseMatrix_Type<double, SparseAvailable_lti_mpc_lkf_ss_A>;
...
inline auto make(void) -> type {
  ...
  return make_SparseMatrix<SparseAvailable_lti_mpc_lkf_ss_A>(
    ...
    static_cast<double>(0.12801926920428286),
    static_cast<double>(1.0),
    static_cast<double>(0.05),
    static_cast<double>(6.400995031689203),
